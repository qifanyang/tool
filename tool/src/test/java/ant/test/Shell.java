...
//			String passwd = JOptionPane.showInputDialog("Enter password");
			...
			UserInfo ui = new MyUserInfo() {
				...
				public boolean promptYesNo(String message) {
					...
					int foo = JOptionPane.showOptionDialog(null, message, "Warning", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null,
							options, options[0]);
					return foo == 0;
				}
			...
			Channel channel = session.openChannel("shell");
			 ...
			 ((ChannelShell)channel).setEnv("LC_ALL", "en_US.UTF-8");
